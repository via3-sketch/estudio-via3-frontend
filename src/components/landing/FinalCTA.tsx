...
export default function FinalCTA() {
  return (
    <section className="bg-[#070707] px-4 py-28">
      <div className="mx-auto max-w-5xl text-center relative">
        ...
        <div className="relative border border-white/10 rounded-2xl p-12 bg-white/5 backdrop-blur">
          ...
          <Link
            href="/plataforma"
            className="flex items-center justify-center w-full sm:w-auto px-10 py-5 rounded-xl font-medium text-lg text-black bg-linear-to-r from-[#C7962D] to-[#E0B84F] transition-all duration-200 hover:brightness-110 hover:shadow-[0_0_30px_rgba(199,150,45,0.25)] active:scale-[0.98]"
          >
