  ...
  const steps = [
    {
      ...
      description:
        "Registrá tu empresa y accedé a la plataforma para comenzar el proceso.",
    },
    {
      number: "02",
      title: "Explorá capacitaciones",
      description:
        "Descubrí programas adaptados a las necesidades y objetivos de tu equipo.",
    },
    {
      number: "03",
      title: "Enviá tu solicitud",
      description:
        "Seleccioná una capacitación, indicá participantes y comenzá a trabajar junto a ViaCore.",
    },
  ];
